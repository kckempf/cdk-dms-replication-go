...
func init() {
	...
	_jsii_.RegisterEnum(
		...
		map[string]interface{}{
			"T3_MICRO": ReplicationInstanceClass_T3_MICRO,
			...
			"X7I_2XLARGE": ReplicationInstanceClass_X7I_2XLARGE,
			"X7I_4XLARGE": ReplicationInstanceClass_X7I_4XLARGE,
			"X7I_8XLARGE": ReplicationInstanceClass_X7I_8XLARGE,
			"X7I_12XLARGE": ReplicationInstanceClass_X7I_12XLARGE,
			"X7I_16XLARGE": ReplicationInstanceClass_X7I_16XLARGE,
			"X7I_24XLARGE": ReplicationInstanceClass_X7I_24XLARGE,
			"X7I_48XLARGE": ReplicationInstanceClass_X7I_48XLARGE,
